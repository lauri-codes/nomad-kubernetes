# FAIRmat Users Meeting: Deploying NOMAD Oasis with Kubernetes

View presentation here: https://lauri-codes.github.io/nomad-kubernetes/

- Date: 16/06/2026
- Speakers: Lauri Himanen
- Location: CSMB
- Duration: 20 minutes
- Language: English
- Target audience: FAIRmat users
- Abstract: Many existing NOMAD Oasis installations rely on Docker Compose, which has long been the recommended and most widely used deployment approach. While this setup works well for smaller environments, it can become limiting when scaling to larger workloads or more complex infrastructures.
